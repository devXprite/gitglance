...
const SearchBox = ({ formAction }) => {
    return (
        ...
        >
            <input
                className="block flex-1 bg-transparent pl-4 text-lg md:text-2xl outline-none"
                name="username"
                type="text"
                placeholder="Enter your github Username"
            />

            <button className="w-14 bg-gray-700 px-5 py-4 hover:bg-gray-600 group-focus-within:bg-gray-600 group-focus-within:text-white md:w-20  ">
